...
namespace TimeClockMTSNETUtility
{
    /// <summary>
    ...
    public sealed class MD5MTS
    {
        ...
        public static byte[] GetHash(byte[] input)
        {
            ...
            {
                MD5MTS.GetHashBlock(input, ref abcd, startIndex);
                startIndex += 64;
            }
            ////  The final data block. 
            return MD5MTS.GetHashFinalBlock(input, startIndex, input.Length - startIndex, abcd, (Int64)input.Length * 8);
        }
